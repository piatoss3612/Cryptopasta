...
export interface BulletinBoardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AGENT"
      | "CP"
...
export interface BulletinBoard extends BaseContract {
  connect(runner?: ContractRunner | null): BulletinBoard;
