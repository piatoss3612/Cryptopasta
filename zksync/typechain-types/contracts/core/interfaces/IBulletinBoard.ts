...
export declare namespace IBulletinBoard {
...
export interface IBulletinBoardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buyReport"
      | "claimSales"
...
export interface IBulletinBoard extends BaseContract {
  connect(runner?: ContractRunner | null): IBulletinBoard;
  waitForDeployment(): Promise<this>;

  interface: IBulletinBoardInterface;
  ...
  getDiscoveryReport: TypedContractMethod<
    [reportId: BigNumberish],
    [IBulletinBoard.DiscoveryReportStructOutput],
    "view"
  >;

  getRating: TypedContractMethod<
    [reportId: BigNumberish],
    [[IBulletinBoard.RatingStatsStructOutput, bigint]],
    "view"
  >;

  getSales: TypedContractMethod<
    [reportId: BigNumberish],
    [[IBulletinBoard.SalesStatsStructOutput, bigint]],
    "view"
  >;
