...
import type {
  IBulletinBoard,
  IBulletinBoardInterface,
} from "../../../../contracts/core/interfaces/IBulletinBoard";
...
export class IBulletinBoard__factory {
  static readonly abi = _abi;
  static createInterface(): IBulletinBoardInterface {
    return new Interface(_abi) as IBulletinBoardInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IBulletinBoard {
    return new Contract(address, _abi, runner) as unknown as IBulletinBoard;
  }
}
